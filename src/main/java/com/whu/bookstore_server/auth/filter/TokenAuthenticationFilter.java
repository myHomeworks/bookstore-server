package com.whu.bookstore_server.auth.filter;


import com.whu.bookstore_server.auth.TokenAuthentication;
...
public class TokenAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest req, HttpServletResponse res, FilterChain fc)
        ...
        if (context.getAuthentication() != null && context.getAuthentication().isAuthenticated() || req.getMethod().equals("GET")) {
            ...
            req.setAttribute("com.whu.bookstore_server.auth.filter.TokenAuthenticationFilter.FILTERED", true);
        }
        fc.doFilter(req, res);
